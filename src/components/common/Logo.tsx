      ...
      <div className="relative w-10 h-10 flex items-center justify-center">
        ...
        <div className="relative w-8 h-8">
          ...
          <motion.div 
            ...
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[2px] h-6 bg-foreground shadow-[0_0_10px_rgba(0,122,255,0.5)] z-20"
          />
          {/* Orbiting Bits */}
          <motion.div 
            animate={{ rotate: 360 }}
            transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
            className="absolute inset-[-4px] border border-dashed border-primary/50 rounded-full"
          />
        </div>
      </div>
      ...
      {!collapsed && (
        ...
        >
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-black tracking-[-0.05em] leading-none text-gradient">SENTINEL</span>
